...
Como desafio para a aula temos uma missão muito especial: analisar os álbuns da nossa rainha BEYONCÉ a fim de descobrir a positividade e popularidade deles e verificar se há alguma correlação entre essas variáveis. Notas para o desafio:

* O ID da Bey no Spotify é o: 6vWDO969PvNqNYHIOW5v0m
* Para pegar os álbuns utilize os parâmetros "include_groups=album" e "country=US" no endpoint de álbuns
* Endpoints necessários:
    + Para pegar informações dos álbuns de um artista: https://api.spotify.com/v1/artists/{ARTISTA_ID}/albums/
    + Para pegar as músicas de um álbum: https://api.spotify.com/v1/albums/{ALBUM_ID}/tracks/?limit=50 (parâmetro limite configurado para 50)
    + Para pegar informações das musicas, como a popularidade: https://api.spotify.com/v1/tracks
    + Para pegar as características das músicas, como a positividade: https://api.spotify.com/v1/audio-features